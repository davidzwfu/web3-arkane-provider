...
The Web3Provider works by wrapping an existing Web3-compatible and exposing it as an ethers.js Provider which can then be used with the rest of the library.
